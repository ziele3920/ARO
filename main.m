...
a1 = 200;
b1 = 300;
a2 = [240,240,250,250,290,290,300,300,350,350];
b2 =[250,250,350,350,390,390,400,400,450,450];
sig1 = [50,50,1,1,sqrt(0.2),sqrt(0.2),sqrt(0.5),sqrt(0.5),sqrt(0.5),sqrt(0.5)];
sig2 = [5,5,1,1,sqrt(0.2),sqrt(0.2),sqrt(0.5),sqrt(0.5),sqrt(0.5),sqrt(0.5)];
